...
contract('Pinning Gas Tests:', function(accounts) {
    ...
    async function tests(pinningInterface) {
        ...
        // result = await pinningInterface.proposeVote(A_SIDECHAIN_ID, common.VOTE_REMOVE_UNMASKED_PARTICIPANT, participantToRemove, "0", "0");
        // console.log("Propose VOTE_ADD_MASKED_PARTICIPANT: " + result.receipt.gasUsed);
        ...
        // let result2 = await common.checkVotingResult(pinningInterface);
        ...
        // const EXPECTED_OFFSET = "0";
        // result = await pinningInterface.proposeVote(A_SIDECHAIN_ID, common.VOTE_REMOVE_MASKED_PARTICIPANT, maskedParticipant1, EXPECTED_OFFSET, "0");
        // console.log("Propose VOTE_REMOVE_MASKED_PARTICIPANT: " + result.receipt.gasUsed);
        // await common.mineBlocks(parseInt(common.VOTING_PERIOD));
        // result = await pinningInterface.actionVotes(A_SIDECHAIN_ID, maskedParticipant);
        // console.log("Action  VOTE_REMOVE_MASKED_PARTICIPANT: " + result.receipt.gasUsed);
        // result2 = await common.checkVotingResult(pinningInterface);
        // assert.equal(true, result2, "incorrect result reported in event");
        //
        //
