...
contract('Add One Sidechain', function(accounts) {
    ...
    it("getVotingPeriod", async function() {
        ...
        await pinningInterface.addSidechain(twoSidechainId, await common.getValidVotingContractAddress(), votingPeriodTen);
        await pinningInterface.addSidechain(oneSidechainId, await common.getValidVotingContractAddress(), votingPeriodEleven);
